...
exports.FriendAcceptResponseDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var FriendRequestResponseDto = function () {
    var _a;
    var _message_decorators;
    var _message_initializers = [];
    var _message_extraInitializers = [];
    return _a = /** @class */ (function () {
            function FriendAcceptResponseDto() {
                this.message = __runInitializers(this, _message_initializers, void 0);
                __runInitializers(this, _message_extraInitializers);
            }
            return FriendAcceptResponseDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _message_decorators = [(0, swagger_1.ApiProperty)({ description: '처리 결과 메시지' })];
...
exports.FriendAcceptResponseDto = FriendRequestResponseDto;
